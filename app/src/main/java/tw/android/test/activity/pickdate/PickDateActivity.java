...
//        Log.d(TAG, "Time3 Formatter3 : " + offsetDateTime3.format(formatter3));
        ...
        try {
            offsetDateTime = OffsetDateTime.parse("2018-01-10T11:39:30.630Z", DateTimeFormatter.ISO_OFFSET_DATE_TIME);
            Log.d(TAG, "OffsetDateTime.parse : " + offsetDateTime);
        } catch (Exception e) {
            e.printStackTrace();
            Log.e(TAG, "OffsetDateTime.parse : " + e.getMessage());
        }

        OffsetDateTime offsetDateTime20 = null;
        try {
            offsetDateTime20 = getOffsetDateTime("2018-01-10T10:39:30.630Z");
        } catch (Exception e) {
            e.printStackTrace();
        }

        try {
            offsetDateTime20 = OffsetDateTime.parse("2018-01-10T10:39:30.630Z", DateTimeFormatter.ISO_OFFSET_DATE_TIME);
            Log.d(TAG, "OffsetDateTime.parse : " + offsetDateTime20);
            Log.d(TAG, "OffsetDateTime compareTo20 : " + offsetDateTime.compareTo(offsetDateTime20));
        } catch (Exception e) {
            e.printStackTrace();
            Log.e(TAG, "OffsetDateTime.parse : " + e.getMessage());
        }
        ...
        try {
            ZonedDateTime zonedDateTime = ZonedDateTime.parse("2018-01-10T11:39:30.630", DateTimeFormatter.ISO_LOCAL_DATE_TIME.withZone(ZoneId.systemDefault()));
            Log.d(TAG, "ZonedDateTime.parse : " + zonedDateTime);
        } catch (Exception e) {
            e.printStackTrace();
            Log.e(TAG, "ZonedDateTime.parse : " + e.getMessage());
        }
    }
